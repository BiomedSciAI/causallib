...
def plot_evaluation_results(results, X, a, y, plot_names="all"):
    ...
    Args:
        ...
        y (pd.Series): outcome
        plot_names (Union[list[str], str], optional): A list of plot names to plot.
    ...
    Returns:
        Dict[str, Dict[str, matplotlib.axis.Axis]]: the Axis objects of the plots in a nested
            dictionary. First key is the phase ("train" or "valid") and the second key is the
            plot name.
    """
    if plot_names == "all":
